...
class detail: [backup](http://piratepad.net/ep/pad/view/5apH3XyWVk/latest)/ [Google doc](https://docs.google.com/document/d/1s3XPAwa2uYlnR45FLoZHyaXnG63tANp_AeF6ZHlAGuw/edit) / [PiratePad](http://piratepad.net/5apH3XyWVk)
...
- **Reading/Watching:** <br> - [Video: Algorithms in pseudocode and flow diagrams](https://www.youtube.com/watch?v=XDWw4Ltfy5w) <br>- [Video: Algorithm](https://www.youtube.com/watch?v=gOKVwRIyWdg) and full ver (optional) is [here](https://www.youtube.com/watch?v=T1os88EvPc4&t=0s)<br> -	[Flow chart symbols by Robert L. Oakman](http://www.wiley.com/college/busin/icmis/oakman/outline/chap05/slides/symbols.htm) <br> -	[Flow chart examples by Richa](https://blog.udemy.com/flowchart-examples/) 
- **Peer-tutoring: Group x** , Topic: JSON <br>- What is JSON? How to use JSON? <br>- Why is it important to know JSON? <br>- How may we understand data processing through JSON? <br>- sample code <br>- What are the relations between data processing and datafied culture? 
